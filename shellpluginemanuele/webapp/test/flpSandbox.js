		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "shell plugin",
									"targetURL": "#shellpluginemanuele-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"shellpluginemanuele-display": {
								"semanticObject": "shellpluginemanuele",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=shellpluginemanuele",
									"url": sap.ui.require.toUrl("shellpluginemanuele")
								}
							}
						}
					}
